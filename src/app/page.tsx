      ...
      <main>
        ...
        <section style={{ paddingBottom: 'var(--section-gap)' }}>
          <div className="container">
            ...
            {/* Bento Grid */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: 'var(--gutter)', height: '900px' }}>
              {/* Hero Card */}
              <Link
                href={`/products/${featured[0].id}`}
                className="product-card"
                style={{ gridColumn: 'span 8', gridRow: 'span 2', position: 'relative', overflow: 'hidden', backgroundColor: 'var(--surface-container-low)' }}
              >
              ...
              {featured.slice(1).map(p => (
                ...
                >
                  <div className="card-image" style={{ flex: 1, position: 'relative', minHeight: '350px' }}>
