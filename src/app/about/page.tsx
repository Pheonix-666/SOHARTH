      ...
      <main style={{ paddingTop: '8.75rem', paddingBottom: 'var(--section-gap)' }}>
        ...
        <section className="container" style={{ marginBottom: '6rem', animation: 'fadeInUp 0.8s cubic-bezier(0.16,1,0.3,1)' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '800px', marginBottom: '4rem' }}>
            <span className="font-label-caps" style={{ color: 'var(--on-surface-variant)', letterSpacing: '0.4em' }}>THE <span className="soharth-font">SOHARTH</span> MANIFESTO</span>
            ...
            <p className="font-body-lg" style={{ color: 'var(--on-surface-variant)', lineHeight: 1.8 }}>
              <span className="soharth-font" style={{ fontWeight: 700 }}>Soharth</span> is born from the silence between stars. We believe clothing is not merely a cover, but an architectural envelope for the modern soul—meticulously drafted and constructed with high-tactility, premium materials that echo the precision of astronomical phenomena.
            </p>
          </div>
        ...
        <section className="container about-cta" style={{ marginTop: 'var(--section-gap)', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2rem' }}>
          ...
          <h2 className="font-headline-lg" style={{ color: 'var(--primary)', maxWidth: '600px', lineHeight: 1.2 }}>EXPERIENCE THE COGNITIVE SIMPLICITY OF <span className="soharth-font">SOHARTH</span></h2>
